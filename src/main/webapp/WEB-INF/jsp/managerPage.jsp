...
<div id="header" class="navbar navbar-default navbar-fixed-top">
  ...
  <nav class="collapse navbar-collapse">
    <ul class="nav navbar-nav">
      <li><a href="#" class="" >Navbar Item 1</a>

      </li>
      <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Statistic<b
              class="caret"></b></a>

        <ul class="dropdown-menu">
          <li><a href="#" class="" onclick="showStatistic('/statistic_CountBuyProduct')">Statistics on the number of sold</a>
          </li>
        </ul>
      </li>
