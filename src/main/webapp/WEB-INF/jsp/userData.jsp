...
<form id="editDataForm" class="form-horizontal" action="javascript:void(null);" onsubmit="saveUserData(${userData.id})">
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-5">
        <input type="text" class="form-control" name="lastName" id="lastNameUserModal" value="${userData.lastName}"
                />
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-5">
        <input type="text" class="form-control" name="address" id="addressUserModal" value="${userData.address}"/>
      </div>
    </div>
