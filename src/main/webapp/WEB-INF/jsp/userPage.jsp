    ...
    <div id="sidebar-wrapper" class="col-md-1">
        <div id="sidebar" class="">
            <ul class="nav list-group">
                <li onclick="show(${user.id})"><a class="list-group-item" href="#"><i class="icon-home icon-1x"></i>My
                    Orders</a>
                </li>

                <li onclick="showNews('/news_get')"><a class="list-group-item" href="#"><i
                        class="icon-home icon-1x"></i>News</a>
                </li>

                <li onclick="showUserData(${user.id})"><a class="list-group-item" href="#"><i
                        class="icon-home icon-1x"></i>Мои данные</a>
                </li>
